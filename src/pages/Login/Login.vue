  ...
  <section class="loginContainer">
    <div class="loginInner">
      <div class="login_header">
        <h2 class="login_logo">food_shop</h2>
        ...
        <form @submit.prevent="login">
          <div :class="{on: loginWay}">
            <section class="login_message">
              ...
              <!-- @click.prevent 阻止点击事件的默认行为，仅执行函数getCode-->
          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <!--ref为元素注册一个唯一标识, vue对象通过$refs属性访问这个元素对象-->
    ...
    methods:{
      ...
      async login(){
        ...
        if(this.loginWay){
          ...
          if(!name){
            //请输入指定的用户名
            this.showAlert('请输入指定的用户名')
            return
          }else if(!pwd){
            //请输入指定的密码
            this.showAlert('请输入指定的密码')
            return
          }else if(!captcha){
            //请输入指定的验证码
            this.showAlert('请输入指定的验证码')
            return
          }
          //发送ajax请求密码登录（登录成功）
        ...
        if(result.code == 0){
          ...
          //将user保存到vuex的state（通过dispatch触发actions）
